          ...
          >
            ...
            >
              ...
              >
                <Flex
                  vertical
                  className="bg-main/[12%] w-full rounded-[12px] border-b-[3px] p-4 lg:p-6 relative"
                >
                  <Image
                    src={HomeBannerIcon}
                    alt="HomeBanner"
                      ...
                      <Flex className="w-full flex items-center gap-x-2">
                        ...
                        <Button className="rounded-full bg-[#E6F1FF] h-8 lg:h-12 w-24 lg:w-[187px] flex items-center gap-x-3">
                          ...
                          <Image
                            src={Logomark}
                            alt="Logomark"
                            className="w-4 h-auto hidden lg:flex"
                          />
                        </Button>
                        <Image
                          src={InfoMark}
                ...
                <Flex vertical className="hidden lg:flex gap-y-6 px-6">
                  <Typography className="text-[18px]/[20px] font-semibold">
                    External Wallets
                  </Typography>
                  <Flex className="gap-x-4">
                    <Button className="h-14 flex items-center gap-x-2">
                      ...
                      />
                      <Typography className="text-[15px]/[26px] font-bold text-main">
                        MetaMask
                      </Typography>
                      <CheckIconSVG />
                    </Button>
                  ...
                  {Array.from({ length: 5 }).map((_, index) => (
                    ...
                    >
                      <Image
                        src={Avatar_senesa}
                        alt="Avatar_senesa"
                        className="w-8 lg:w-10 h-auto outline-1"
                      />
            ...
            >
              ...
              >
                <Flex className="w-full flex justify-between items-center">
                  ...
                  <Typography className="text-[12px]/[14px] lg:text-[16px]/[18px] text-secondary">
                    View all
                  </Typography>
                </Flex>
