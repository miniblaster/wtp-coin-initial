...
import PaymentFailedIllustration from "@/public/images/general/home/PaymentFailed.svg";
import PaymentSuccessIllustration from "@/public/images/general/home/PaymentSuccess.svg";

interface ISendPaymentProps {
  setIsPaymentSent?: any;
  isPaymentSent?: boolean;
  setIsPaymentSuccess?: any;
      ...
      <ConfigProvider>
        <Modal
          ...
          footer={[
            !isPaymentSent ? (
              ...
              <Flex key={"SendPayment"} className="w-full p-3 justify-center">
                <Button
                  onClick={handleOk}
                  className="flex justify-center items-center w-[116px] gap-x-2 h-12 bg-main text-[14px]/[16px] font-semibold text-[white]"
                >
                  Back
                </Button>
              </Flex>
        ...
        >
          {!isPaymentSent ? (
            ...
            <>
              <Flex className="flex-col w-full px-[22px] py-4 gap-y-2 mb-6">
                <Typography className="text-[16px]/[24px] font-semibold text-center">
                  Your transaction has been completed successfully!
                </Typography>
                <Typography className="text-[12px]/[18px] text-secondary text-center">
                  Need help? Reach out to us at support@wetp.io
                </Typography>
              </Flex>
              <Flex className="w-full justify-center">
                <Image src={PaymentSuccessIllustration} alt="PaymentSuccess" className="w-[164px] h-auto" />
              </Flex>
            </>
          ) : (
            <>
              <Flex className="flex-col w-full px-[22px] py-4 gap-y-2 mb-6">
                ...
                <Typography className="text-[12px]/[18px] text-secondary text-center">
                  Try again or reach out to us for support at support@wetp.io.
                </Typography>
              </Flex>
              <Flex className="w-full justify-center">
                <Image src={PaymentFailedIllustration} alt="PaymentFailed" className="w-[164px] h-auto" />
              </Flex>
            </>
          )}
        </Modal>
